    ...
    <head>
        ...
        <style>
            ...
            .container { 
                ...
                background: #fff; 
                padding: 35mm 15mm 10mm 15mm; /* Increased top padding to clear header */
                margin: 0 auto; 
            ...
            h1 { 
                ...
                padding-bottom: 4px; 
                margin-bottom: 5px; /* Reduced further */
                text-align: center; 
                letter-spacing: 0.05em; 
                margin-top: 0;
            }
            
            .hero-section { display: flex; flex-direction: column; align-items: center; margin-bottom: 8px; flex-shrink: 0; }
            ...
            .benefit-title::before { content: '✓'; margin-right: 4px; font-weight: bold; }
            .benefit-detail { font-size: 10px; color: #555; line-height: 1.3; }
            ...
            .price-val { font-size: 16px; font-weight: bold; color: #f1c40f; }
            .target-val { font-size: 10px; opacity: 0.9; margin-top: 2px; }
            ...
            .comment-text { font-style: italic; color: #5d5d5d; line-height: 1.5; font-size: 12px; }
